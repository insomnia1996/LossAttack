...
from LossAttack.libs.nlpaug import SentenceAugmenter
from LossAttack.libs import nlpaug as nml
...
class ContextualWordEmbsForSentenceAug(SentenceAugmenter):
    ...
    :param str model_path: Model name or models path. It used pytorch-transformer to load the models. Tested
    ...
    def get_model(cls, model_path, device='cuda', force_reload=False, temperature=1.0, top_k=None, top_p=0):
        ...
        raise ValueError('Model name value is unexpected. Only support xlnet and gpt2 models.')
