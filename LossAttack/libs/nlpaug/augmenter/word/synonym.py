...
from LossAttack.libs.nlpaug.util import Action, PartOfSpeech, WarningException, WarningName, WarningCode, WarningMessage
from LossAttack.libs.nlpaug.model import word_dict as nmw
