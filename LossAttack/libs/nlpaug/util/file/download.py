...
class DownloadUtil:
    ...
    >>> from LossAttack.libs.nlpaug import DownloadUtil
    """
    ...
    def download_glove(model_name, dest_dir):
        """
        :param str model_name: GloVe pre-trained models name. Possible values are 'glove.6B', 'glove.42B.300d',
    ...
    def download_fasttext(model_name, dest_dir):
        """
        :param str model_name: GloVe pre-trained models name. Possible values are 'wiki-news-300d-1M',
