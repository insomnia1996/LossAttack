...
class Vocab(object):
    ...
    def __init__(self, words, chars, tags, rels):
        ...
        self.barttkn = BartTokenizer.from_pretrained('facebook/bart-base', cache_dir='/home/lyt/LossAttack/data/pretrained/bart-base')
    ...
    def read_embeddings(self, embed, smooth=True):
        ...
        '''
        bart = BartModel.from_pretrained('facebook/bart-base', cache_dir='/home/lyt/LossAttack/data/pretrained/bart-base')
...
class Vocab_for_DEC(object):
    ...
    def __init__(self, words, chars, tags, rels):
        ...
        self.n_train_words = self.n_words
        self.barttkn = BartTokenizer.from_pretrained('facebook/bart-base', cache_dir='/home/lyt/LossAttack/data/pretrained/bart-base')
        #self.nlp = StanfordCoreNLP(r'/home/lyt/stanford-corenlp-4.2.2')不能放在init里，否则pickle有问题
    ...
    def numericalize(self, corpus, synt_vocab, training=True):
        ...
        for idx in trange(len(corpus.words)):
            ...
            words.append(tmp1)
            sub_len.append(tmp2)
        self.nlp = StanfordCoreNLP(r'/home/lyt/stanford-corenlp-4.0.0', memory='8g', timeout=50000)
        chars = [self.char2id(seq) for seq in corpus.words]
