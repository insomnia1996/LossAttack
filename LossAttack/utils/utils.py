from LossAttack.libs.nlpaug.augmenter import word as naw
from LossAttack.utils.aug import RandomTagAug

def get_blackbox_augmentor(config, method, path, revised_rate, vocab = None, ftrain=None):
    aug = None
    ...
    elif method == 'parabart':
        aug = naw.DECAug(config, model_path=path, aug_p=revised_rate, aug_min=1, top_k=110)
    else:
