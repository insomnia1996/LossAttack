...
from LossAttack.utils.vocab import Vocab, Vocab_for_DEC
...
from LossAttack.task import DECTask
from LossAttack.utils.parser_helper import init_model
...
class DEC(object):
    ...
    def fetch_data(self, number_path, sent_path, adv_path):
        ...
        if shuffle:
            ...
            train_or_dev='dev'
        with open('/home/lyt/LossAttack/data/ptb/synt_vocab.pkl', 'rb') as f:
