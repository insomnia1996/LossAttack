...
from LossAttack.libs.luna import log_config, log
from LossAttack.cmds.zeng.whitebox.base import WhiteBoxAttackBase
...
class WhiteHack(WhiteBoxAttackBase):
    ...
    def __call__(self, config):
        ...
        # LossAttack.pretrained.register_backward_hook(embed_hook)
