...
from dpattack.models.modules import (MLP, IndependentDropout_DEC, SharedDropout)
from dpattack.models import WordParser, word
import torch
...
from dpattack.cmds.DEC.syntemb import SyntEmb
